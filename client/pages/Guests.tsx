...
const mockGuests: Guest[] = [
  {
    ...
    notes: "Cliente VIP, prefiere habitaciones con vista al mar",
    emergencyContact: {
      name: "María Mendez",
  ...
  },
  {
    ...
    nationality: "Mexicana",
    documentType: "id_card",
    documentNumber: "GASM780322",
    preferredRoomType: "suite",
    allergies: ["Lactosa"],
    specialRequests: ["Cena romántica", "Decoración especial"],
    notes: "Cliente frecuente, celebra aniversario cada año",
    emergencyContact: {
      name: "Roberto Garcia",
  ...
  },
  {
    ...
    documentNumber: "MAR820910HDF",
    preferredRoomType: "familiar",
    allergies: [],
    specialRequests: ["Cunas para niños"],
    notes: "Viaja con familia, 2 niños pequeños",
    emergencyContact: {
      name: "Patricia Martinez",
      phone: "+52 555 5432109",
      relationship: "Esposa",
    },
  },
  {
    ...
    notes: "Cliente nuevo, primera visita",
    emergencyContact: {
      name: "Roberto Torres",
      phone: "+1 305 9876543",
      relationship: "Padre",
  ...
  },
  {
    ...
    nationality: "Mexicana",
    documentType: "id_card",
    documentNumber: "SIGP951205",
    preferredRoomType: "simple",
    allergies: [],
    specialRequests: [],
    notes: "Cliente joven, viajes cortos de fin de semana",
    emergencyContact: {
      name: "Carmen Silva",
      phone: "+52 555 2109876",
      relationship: "Madre",
    },
  },
  {
    ...
    nationality: "Mexicana",
    documentType: "passport",
    documentNumber: "M98765432",
    preferredRoomType: "suite",
    allergies: ["Frutos secos"],
    specialRequests: ["Spa incluido", "Vista premium"],
    notes: "Cliente de alto valor, prefiere estancias largas",
    emergencyContact: {
      name: "Fernando Ruiz",
      phone: "+52 555 3456789",
      relationship: "Esposo",
  ...
  },
  {
    ...
    nationality: "Mexicana",
    documentType: "id_card",
    documentNumber: "DIMR870814",
    preferredRoomType: "doble",
    allergies: [],
    specialRequests: ["Servicio de lavandería"],
    notes: "Viajero de negocios frecuente",
    emergencyContact: {
      name: "Sandra Diaz",
      phone: "+52 555 4567890",
